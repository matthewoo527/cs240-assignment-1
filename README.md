...
__[Test cases]__([#5. Test boundary cases, including zero, the largest supported unsigned value, and at least one negative two's-complement value.](https://github.com/matthewoo527/cs240-assignment-1/blob/main/README.md#5-test-boundary-cases-including-zero-the-largest-supported-unsigned-value-and-at-least-one-negative-twos-complement-value))
